...
class Enemy : public Actor {
 ...
 public:
  Enemy()
      : Enemy("Enemy Name", 100, 10, 10, 10, 10, 10, 10, "rock attack",
              "paper attack", "scissor attack", "rock defence", "paper defence",
              "scissors defence") {}
  Enemy(string argName, int ArgHP, double rAtk, double pAtk, double sAtk,
        double rDef, double pDef, double sDef, string rockAtkHint,
        string paperAtkHint, string scissorsAtkHint, string rockDefHint,
        string paperDefHint, string scissorsDefHint)
      : Actor(argName, ArgHP) {
    rockAttack = rAtk;
    rockDefence = rDef;
    paperAttack = pAtk;

...
public:
    ...
    void set_rockAtk(int bonusAtk)
    {
        rockAttack = (currentweapon.get_rockAtk() * Attack + bonusAtk);
    };
    ...
    void set_paperAtk()
    {
     ...
     void set_paperAtk(int bonusAtk)
    {
        rockAttack = (currentweapon.get_paperAtk() * Attack + bonusAtk);
    };
    ...
    void set_scissorsAtk()
    {
       ...
       void set_scissorsAtk(int bonusAtk)
    {
        rockAttack = currentweapon.get_scissorsAtk() * Attack + bonusAtk;
    };
    ...
    void set_rockDef()
    {
      ...
      void set_rockDef(int bonusDef)
    {
        rockDefence = Defence * currentarmour.get_rockDef() + bonusDef;
    };
    ...
    void set_paperDef()
    {
       ...
       void set_paperDef(int bonusDef)
    {
        paperDefence = Defence * currentarmour.get_paperDef() + bonusDef;
    };   
    ...
    void set_scissorsDef()
    {
       ...
       void set_scissorsDef(int bonusDef)
    {
        scissorsDefence = Defence * currentarmour.get_scissorsDef() + bonusDef;
    };
